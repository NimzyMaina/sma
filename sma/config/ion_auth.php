 ...
 */
$config['site_title']                 = "cPOS";       // Site Title, example.com This is not more functional
...
$config['lockout_time']               = 120;                 // The number of seconds to lockout an account due to exceeded attempts
