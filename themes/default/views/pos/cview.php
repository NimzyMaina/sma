...
.table th { border-bottom: 1px solid #000000; margin-bottom: 3px; }
.table td { padding:0; padding-bottom: 3px; }
...
<!--<img src="<?php echo $this->config->base_url(); ?>assets/uploads/logos/<?php echo $biller->logo; ?>" alt="Biller Logo">
	...
	<?php $r = 1; foreach ($rows as $row):?>
			<tr>
                ...
                ?></td>
                <td style="text-align:center; width:50px;"><?php echo $this->sma->formatNumber($row->quantity); ?></td>
