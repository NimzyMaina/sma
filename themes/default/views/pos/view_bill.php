...
<!-- just remove the class with-promo-space from body to make it full page -->
    ...
    <div class="wrap">
        <div class="bill" id="bill">
            ...
            <table style="width:100%; float:right; padding:5px; color:#000; background: #FFF;" id="totalTable">
                <tbody><tr>
                    <td style="border-left: 1px solid #ddd; padding-left:10px; text-align:left; font-weight:normal;">Items</td>
                    ...
                    <td style="border-right: 1px solid #ddd; text-align:right; padding-right:10px; font-weight:bold;"><span id="total">0.00</span></td>
                </tr>
                <tr>
                    <td style="border-left: 1px solid #ddd; padding-left:10px; text-align:left; font-weight:normal;">Order Tax</td>
                    <td style="text-align:right; padding-right:10px; font-weight:bold;"><span id="ttax2">0.00</span></td>
                    <td style="padding-left:10px; text-align:left; ">Discount</td>
                    <td style="border-right: 1px solid #ddd; text-align:right; padding-right:10px; font-weight:bold;"><span id="tds">0.00</span></td>
                </tr>
                <tr>
                    <td colspan="2" style="padding: 5px 0px 5px 10px; text-align:left; font-size: 1.4em; border: 1px solid #333; font-weight:bold; background:#333; color:#FFF;">Total Payable</td>
                    <td colspan="2" style="text-align:right; padding:5px 10px 5px 0px; font-size: 1.4em; border: 1px solid #333; font-weight:bold; background:#333; color:#FFF;"><span id="gtotal">0.00</span></td>
                </tr>
            </tbody></table>
    ...
    $(document).ready(function () {
        loadItems();
        window.setInterval(function(){loadItems();}, 1000);
    });
    function loadItems() {
        ...
        if (localStorage.getItem('positems')) {
            ...
            $.each(positems, function () {
                ...
                tr_html = '<td><span class="sname" id="name_' + row_no + '">' + item_name + ' </span></td>';
