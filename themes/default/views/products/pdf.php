    ...
    <body>
        <div class="row">
            <div class="col-lg-12">
                ...
                <img src="<?=base_url()?>assets/uploads/qrcode<?=$this->session->userdata('user_id')?>.png" alt="<?=site_url('products/view/'.$product->id);?>" style="float:right;"/>
                <?php $br = $this->sma->save_barcode($product->code, $product->barcode_symbology, 70, false); ?>
                <img src="<?=base_url()?>assets/uploads/barcode<?=$this->session->userdata('user_id')?>.png" alt="<?=$product->code?>" style="float:right;"/>
                <div class="clearfix"></div>
                <div class="row">
                    <div class="col-sm-5">
                    <?php if($product->image != 'no_image.png') { ?><img src="<?=base_url()?>assets/uploads/<?=$product->image?>" alt="<?=$product->name?>" class="img-responsive img-thumbnail" /><?php } ?>
                    </div>
                    <div class="col-sm-7">
                        <div class="clearfix"></div>
