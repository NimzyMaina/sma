...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo form_open_multipart("products/edit_damage/" . $product_id."/".$damage->id, $attrib);
        ?> 
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="controls"> <?php echo form_input('quantity', (isset($_POST['quantity']) ? $_POST['quantity'] : $this->sma->formatNumber($damage->quantity)), 'class="form-control input-tip" id="quantity" required="required"'); ?> </div>
            </div>
            ...
            <?php } else { echo form_hidden('option', 0); } ?>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="controls"> <?php echo form_textarea('note', (isset($_POST['note']) ? $_POST['note'] : $this->sma->decode_html($damage->note)), 'class="form-control" id="note" required="required"'); ?> </div>
            </div>

        </div>
        <div class="modal-footer">
    <?php echo form_submit('edit_damage', lang('edit_damage'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
<?php echo form_close(); ?>  
</div>
