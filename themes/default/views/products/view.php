 ...
 <ul id="myTab" class="nav nav-tabs">
    ...
    <li class=""><a href="#damages" class="tab-grey"><?=lang('damages')?></a></li>
    ...
    <div id="details" class="tab-pane fade in">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:70%;"><?php echo $barcode ?>
                                            ...
                                            <img src="<?=base_url()?>assets/uploads/qrcode<?=$this->session->userdata('user_id')?>.png" alt="<?=$product->name?>" class="pull-right" /></td>
                                        </tr>
                                        <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $this->sma->formatNumber($product->alert_quantity); ?></td>
                                    </tr>
                                    <?php } ?>
                                    <?php if($variants) { ?>
                                    <tr>
                                        <td><?= lang("product_variants"); ?></td>
                                        <td><?php foreach($variants as $variant) { echo '<span class="label label-primary">'.$variant->name.'</span> '; } ?></td>
                                    </tr>
                                    <?php } ?>
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-condensed dfTable two-columns">
                                        ...
                                        <tbody>
                                            <?php 
                                            if($product->cf1) { echo '<tr><td>'.lang("pcf1").'</td><td>'.$product->cf1.'</td></tr>'; } 
                                            if($product->cf2) { echo '<tr><td>'.lang("pcf2").'</td><td>'.$product->cf2.'</td></tr>'; }
                                            if($product->cf3) { echo '<tr><td>'.lang("pcf3").'</td><td>'.$product->cf3.'</td></tr>'; }
                                            if($product->cf4) { echo '<tr><td>'.lang("pcf4").'</td><td>'.$product->cf4.'</td></tr>'; }
                                            if($product->cf5) { echo '<tr><td>'.lang("pcf5").'</td><td>'.$product->cf5.'</td></tr>'; }
                                            if($product->cf6) { echo '<tr><td>'.lang("pcf6").'</td><td>'.$product->cf6.'</td></tr>'; }
                                            ?>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <table class="table table-bordered table-striped table-condensed dfTable two-columns">
                                    ...
                                    <tbody>
                                        <?php foreach($combo_items as $combo_item) {
                                         echo '<tr><td>'.$combo_item->name.' ('.$combo_item->code.') </td><td>'.$this->sma->formatNumber($combo_item->qty).'</td></tr>';   
                                     } ?>
                                 </tbody>
                             </table>
                         </div>
                            ...
                            <table class="table table-bordered table-striped table-condensed dfTable">
                                ...
                                <tbody>
                                    ...
                                    foreach($options as $option) { 
                                        if($option->wh_qty != 0) {
                                            echo '<tr><td>'.$option->wh_name.'</td><td>'.$option->name.'</td><td class="text-center">'.$this->sma->formatNumber($option->wh_qty).'</td>';
        ...
        <div class="buttons">
            <div class="btn-group btn-group-justified">
                ...
                <div class="btn-group"><a data-target="#myModal2" data-toggle="modal" href="<?=site_url('products/add_damage/'.$product->id)?>" class="tip btn btn-warning"  title="<?=lang('damage')?>"><i class="fa fa-plus-circle"></i> <span class="hidden-sm hidden-xs"><?=lang('damage')?></span></a></div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var sold_chart = new Highcharts.Chart({
                chart: { renderTo: 'soldchart', type: 'line', width: <?= $purchased ? "($('#details').width()-160)/2" : "$('#details').width()-100"; ?> },
                ...
                <div class="row" style="margin-bottom: 15px;">
                    <div class="col-sm-<?= $purchased ? '6' : '12'; ?>">
                        <div class="box" style="border-top: 1px solid #dbdee0;">
                            <div class="box-header">
                                <h2 class="blue"><i class="fa-fw fa fa-bar-chart-o"></i><?= lang('sold'); ?></h2>
                            </div>
                            <div class="box-content"> 
                                <div class="row">            
                                    <div class="col-md-12">
                    ...
                    <div class="col-sm-6">
                        <div class="box" style="border-top: 1px solid #dbdee0;">
                            <div class="box-header">
                                <h2 class="blue"><i class="fa-fw fa fa-bar-chart-o"></i><?= lang('purchased'); ?></h2>
                            </div>
                            <div class="box-content"> 
                                <div class="row">            
                                    <div class="col-md-12">
...
<div id="sales" class="tab-pane fade">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            {column_number : 8, filter_default_label: "[<?=lang('payment_status');?>]", filter_type: "text" },
            ], "footer");
    });
</script>
<div class="box">
...
<div id="quotes" class="tab-pane fade">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            {column_number : 2, filter_default_label: "[<?=lang('biller');?>]", filter_type: "text"},
            {column_number : 3, filter_default_label: "[<?=lang('customer');?>]", filter_type: "text" },
            {column_number : 5, filter_default_label: "[<?=lang('grand_total');?>]", filter_type: "text" },
            {column_number : 6, filter_default_label: "[<?=lang('status');?>]", filter_type: "text" },
            ], "footer");
        });
</script>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-heart-o nb"></i><?= $product->name.' '.lang('quotes'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                ...
                <li class="dropdown"><a href="#" id="image1" class="tip image" title="<?=lang('save_image')?>"><i class="icon fa fa-file-picture-o"></i></a></li>
            </ul>
        </div>
    </div>
    <div class="box-content">
...
<div id="purchases" class="tab-pane fade">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            {column_number : 8, filter_default_label: "[<?=lang('status');?>]", filter_type: "text" },
            ], "footer");
});
</script>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-star nb"></i><?= $product->name.' '.lang('purchases'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
...
<div id="transfers" class="tab-pane fade">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            {column_number : 0, filter_default_label: "[<?=lang('date');?> (yyyy-mm-dd)]", filter_type: "text" },
            {column_number : 1, filter_default_label: "[<?=lang('reference_no');?>]", filter_type: "text" },
            {column_number : 3, filter_default_label: "[<?=lang("warehouse").' ('.lang('from').')';?>]", filter_type: "text" },
            {column_number : 4, filter_default_label: "[<?=lang("warehouse").' ('.lang('to').')';?>]", filter_type: "text" },
            {column_number : 5, filter_default_label: "[<?=lang('grand_total');?>]", filter_type: "text" },
            {column_number : 6, filter_default_label: "[<?=lang('status');?>]", filter_type: "text" },
            ], "footer");
        });
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-star-o nb"></i><?= $product->name.' '.lang('transfers'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
    ...
    <script>
        $(document).ready(function() {
            $('#dmpData').dataTable({
                ...
                "aaSorting": [[0, "desc"]],
                "iDisplayLength": <?= $Settings->rows_per_page ?>,
                'sAjaxSource': '<?= site_url('products/getdamageproducts/?v=1&product='.$product->id) ?>',
                'fnServerData': function(sSource, aoData, fnCallback)
                {
                ...
                "aoColumns": [
                {"mRender": fld}, null, null, null, {"mRender": decimalFormat}, null, {"bSortable": false}
                ]
            }).fnSetFilteringDelay().dtFilter([
            {column_number : 0, filter_default_label: "[<?=lang('date');?> (yyyy-mm-dd)]", filter_type: "text" },
            ...
            {column_number : 3, filter_default_label: "[<?=lang('product_variant');?>]", filter_type: "text" },
            {column_number : 4, filter_default_label: "[<?=lang('quantity');?>]", filter_type: "text" },
            {column_number : 5, filter_default_label: "[<?=lang('warehouse');?>]", filter_type: "text" },
            ], "footer");
        });
</script>
<style type="text/css">#dmpData th:last-childe { width: 100px !important; }</style>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-filter nb"></i><?= $product->name.' '.lang('damages'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
    ...
    <script>
        $(document).ready(function() {
            var oTable = $('#PRESLData').dataTable({
                ...
                "aoColumns": [{"mRender": fld}, null, null, null, null, {"bSearchable": false, "mRender": pqFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}],
                "fnFooterCallback": function(nRow, aaData, iStart, iEnd, aiDisplay) {
                    var sc = 0, gtotal = 0;
                    for (var i = 0; i < aaData.length; i++) {
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-random nb"></i><?= $product->name.' '.lang('returns'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
...
<div id="PI" class="tab-pane fade">
    <div class="box">
        <div class="box-header">
            <h2 class="blue"><i class="fa-fw fa fa-file-text-o nb"></i><?= $product->name.' '.lang('pi'); ?></h2>
        </div>
        <div class="box-content">
            <div class="row">
                <div class="col-lg-12">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#pdf4').click(function(event) {
            event.preventDefault();
            window.location.href = "<?=site_url('products/getdamageproducts/pdf/?v=1&product='.$product->id)?>";
            return false;
        });
        $('#xls4').click(function(event) {
            event.preventDefault();
            window.location.href = "<?=site_url('products/getdamageproducts/0/xls/?v=1&product='.$product->id)?>";
            return false;
        });
