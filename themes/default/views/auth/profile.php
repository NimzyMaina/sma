...
<div class="row">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input type="text" name="user_code" class="form-control" id="user_code" value="<?= $user->code ?>" required="required" />
                                            </div>
                                            <div class="form-group">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="no">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        echo form_dropdown('warehouse', $wh, (isset($_POST['warehouse']) ? $_POST['warehouse'] : $user->warehouse_id), 'id="warehouse" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("warehouse") . '" required="required" style="width:100%;" ');
                                                                        ?> 
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <?php echo lang('target', 'target'); ?> 
                                                                        <div class="controls">
                                                                            <input type="number" id="target" name="target" class="form-control" pattern=".{4,20}"/>
                                                                        </div>
                                                                    </div>
    ...
    <script>
        $(document).ready(function () {
            $('#change-password-form').bootstrapValidator({ message: 'Please enter/select a value', submitButtons: 'input[type="submit"]' });
        });
    </script>
    <?php if ($Owner && $id != $this->session->userdata('user_id')) { ?>
