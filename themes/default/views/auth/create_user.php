                    ...
                    <div class="col-md-12">
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="user_code" name="user_code" class="form-control" required="required" pattern=".{4,20}"/>
                                </div>
                            </div>                            
                            <div class="form-group">
                        ...
                        <div class="col-md-5 col-md-offset-1">
                            ...
                            <div class="row">
                                <div class="col-md-8"><label class="checkbox" for="notify"><input type="checkbox" name="notify" value="1" id="notify" checked="checked" /> <?= lang('notify_user_by_email') ?></label>
                                </div>
                                <div class="clearfix"></div>
                            </div>
