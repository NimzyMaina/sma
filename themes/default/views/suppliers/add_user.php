...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
                echo form_open("suppliers/add_user/".$company->id, $attrib); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <?php $opts = array('male' => lang('male'), 'female' => lang('female')); echo form_dropdown('gender', $opts, '', 'class="form-control select" id="gender" required="required"'); ?>
                                </div>
                            </div>
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="form-group">
                                    ...
                                    <div class="row">
                                    <div class="col-md-6 col-sm-6"><label class="checkbox" for="active"><input type="radio" name="status" value="1" id="active" checked="checked"/> <?= lang('active') ?></label></div>
                                    <div class="col-md-6 col-sm-6"><label class="checkbox" for="inactive"><input type="radio" name="status" value="0" id="inactive"/> <?= lang('inactive') ?></label></div>
                                                </div>
                                
                            </div>
                            
                    <div class="form-group"><strong><?=lang('notify_user')?></strong><label class="checkbox" for="notify"><input type="checkbox" name="notify" value="1" id="notify" checked="checked" /> <?= lang('notify_user_by_email') ?></label></div>
