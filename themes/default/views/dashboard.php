                                            ...
                                            <table id="sales-tbl" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-hover table-striped" style="margin-bottom: 0;">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><?= $this->lang->line("product_tax"); ?></th>
                                                ...
                                                <tbody>
                                                    <?php if(!empty($sales)) { 
                                                        ...
                                                        foreach($sales as $order) {
                                                            ...
                                                            <td class="text-right">'.$this->sma->formatMoney($order->total).'</td>
                                                            <td class="text-right">'.$this->sma->formatMoney($order->total_tax).'</td>
                                            ...
                                            <tbody>
                                                <?php if(!empty($quotes)) { 
                                                    ...
                                                    foreach($quotes as $quote) {
                                                        ...
                                                        <td class="text-right">'.$this->sma->formatMoney($quote->total).'</td>
                                                    </tr>';
                                                    $r++;
                                                }        
                                            } else { ?>
        ...
        $('#lmbschart').highcharts({
            ...
            series: [{
                ...
                data: [<?php
                    ...
                    ?>],
                dataLabels: { enabled: true, rotation: -90, color: '#000', align: 'right', y: -25, style: { fontSize: '12px' } }
            }]
        });
    $('#bschart').highcharts({
        chart: { type: 'column' },
...
<div class="row" style="margin-bottom: 15px;">
    <div class="col-sm-6">
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><i class="fa-fw fa fa-bar-chart-o"></i><?= lang('best_seller'),' ('.date('M-Y', time()).')'; ?></h2>
            </div>
            <div class="box-content"> 
                <div class="row">            
                    <div class="col-md-12">
    ...
    <div class="col-sm-6">
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><i class="fa-fw fa fa-bar-chart-o"></i><?= lang('best_seller').' ('.date('M-Y', strtotime('-1 month')).')'; ?></h2>
            </div>
            <div class="box-content"> 
                <div class="row">            
                    <div class="col-md-12">
