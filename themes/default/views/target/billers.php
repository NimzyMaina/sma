...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('target_management')." for ".$targets[0]->full_name; ?></h2>
                ...
                <div class="box-icon">
                <ul class="btn-tasks">
                    <li class="dropdown"><a href="<?=site_url('target/export').'/'.$this->uri->segment(3).'/1?s=1';?>" id="pdf" class="tip" title="<?=lang('download_pdf')?>"><i class="icon fa fa-file-pdf-o"></i></a></li>
                    <li class="dropdown"><a href="<?=site_url('target/export').'/'.$this->uri->segment(3).'/0/1?s=1';?>" id="xls" class="tip" title="<?=lang('download_xls')?>"><i class="icon fa fa-file-excel-o"></i></a></li>
                </ul>
            </div>
    </div>
