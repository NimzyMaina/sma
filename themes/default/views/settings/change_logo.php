    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <?= lang("site_logo", "site_logo") ?>
                <input id="site_logo" type="file" name="site_logo" data-show-upload="false" data-show-preview="false" class="form-control file">
            </div>
            <div class="form-group">
            <?= lang("biller_logo", "biller_logo") ?>
                <input id="biller_logo" type="file" name="biller_logo" data-show-upload="false" data-show-preview="false" class="form-control file">
