<script>
    $(document).ready(function() {
        ...
        $('#CURData').dataTable({
            ...
            "aoColumns": [ {"bSortable": false, "mRender": checkbox}, null, null, {"mRender": currencyFormat}, {"mRender": tax_type}, {"bSortable": false} ]
        });
    });
</script>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?php echo site_url('system_settings/add_tax_rate'); ?>" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> <?= lang('add_tax_rate') ?></a></li>
                        
                        <li><a href="#" id="excel" data-action="export_excel"><i class="fa fa-file-excel-o"></i> <?= lang('export_to_excel') ?></a></li>
                        <li><a href="#" id="pdf" data-action="export_pdf"><i class="fa fa-file-pdf-o"></i> <?= lang('export_to_pdf') ?></a></li>
                        <li class="divider"></li>
                        <li><a href="#" id="delete" data-action="delete"><i class="fa fa-trash-o"></i> <?= lang('delete_tax_rates') ?></a></li>
