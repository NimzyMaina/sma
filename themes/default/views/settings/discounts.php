<script>
    $(document).ready(function() {
        ...
        $('#CURData').dataTable({
            ...
            "aoColumns": [ {"bSortable": false, "mRender": checkbox}, null, null, {"mRender": discount_type}, {"bSortable": false} ]
        });
    });
</script>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?php echo site_url('system_settings/add_discount'); ?>" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> <?= lang('add_discount') ?></a></li>
