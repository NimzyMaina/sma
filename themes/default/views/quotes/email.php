...
<?= lang("to", 'to'); ?>
                <input type="email" name="to" id="to" class="form-control" value="<?=$customer->email?>" required="required" />
            </div>
...
<?php echo form_textarea($note, (isset($_POST['note']) ? $_POST['note'] : ""), 'class="form-control" id="note" '); ?>
        ...
        <div class="modal-footer">
            <a href="#" class="btn btn-sm btn-default pull-left toggle_form"><?php echo $this->lang->line("show_bcc"); ?></a>
