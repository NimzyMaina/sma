<script type="text/javascript">
    ...
    $(document).ready(function() {
        if(localStorage.getItem('remove_slls')) {
            ...
            if(localStorage.getItem('payment_note_1')) { localStorage.removeItem('payment_note_1'); }
        ...
        <?php if ($Owner || $Admin) { ?>
            if (!localStorage.getItem('sldate')) {
                $( "#sldate" ).datetimepicker({format: site.dateFormats.js_ldate, fontAwesome: true, language: 'sma', weekStart: 1, todayBtn: 1, autoclose: 1, todayHighlight: 1, startView: 2, forceParse: 0}).datetimepicker('update', new Date());
            }
            ...
            <?php } ?>
            if(!localStorage.getItem('slref')) { localStorage.setItem('slref', '<?=$slnumber?>'); }
            ItemnTotals();
            ...
            <div class="col-lg-12">
                ...
                <div class="row">            
                    <div class="col-lg-12">
                        ...
                        <?php if(!$Settings->restrict_user || $Owner) { ?>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                ?> 
                                <div class="input-group-addon no-print" style="padding: 2px 5px;"><a href="<?= site_url('custom/add_route'); ?>" id="add-route" class="external" data-toggle="modal" data-target="#myModal"><i class="fa fa-2x fa-plus-circle" id="addIcon"></i></a></div>
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("outlet_id", "outlet_id"); ?>
                                <div class="input-group">
                                <?php
                                echo form_dropdown('outlet_id',$outlets,set_value('outlet_id'),'id="outlet_id" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("outlet_id") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                                ?> 
                                <div class="input-group-addon no-print" style="padding: 2px 5px;"><a href="<?= site_url('custom/add_outlet'); ?>" id="add-outlet" class="external" data-toggle="modal" data-target="#myModal"><i class="fa fa-2x fa-plus-circle" id="addIcon"></i></a></div>
                                </div>
                            </div>
                        </div>
                         ...
                         <!-- <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("route_id","route_id"); ?>
                                <?php echo form_input('route_id', (isset($_POST['route_id']) ? $_POST['route_id'] : ""), 'class="form-control" id="route_id" required="required"'); ?>
                            </div>
                        </div> -->
                        ...
                        <!-- <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("outlet_id","outlet_id"); ?>
                                <?php echo form_input('outlet_id', (isset($_POST['outlet_id']) ? $_POST['outlet_id'] : ""), 'class="form-control" id="outlet_id" required="required"'); ?>
                            </div>
                        </div> -->
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("receipt_no","receipt_no"); ?>
                                <?php echo form_input('receipt_no', (isset($_POST['receipt_no']) ? $_POST['receipt_no'] : ""), 'class="form-control" id="receipt_no" required="required"'); ?>
                            </div>
                        </div>
                        ...
                        <div class="well well-sm">
                            <div class="form-group" style="margin-bottom:0;">
                                <div class="input-group wide-tip">
                                    ...
                                    <div class="input-group-addon" style="padding-left: 10px; padding-right: 10px;"><a href="#" id="addManually" class="tip" title="<?=lang('add_product_manually')?>"><i class="fa fa-2x fa-plus-circle addIcon" id="addIcon"></i></a></div>
                                    <div class="input-group-addon" style="padding-left: 10px; padding-right: 10px;"><a href="#" id="sellGiftCard" class="tip" title="<?=lang('sell_gift_card')?>"><i class="fa fa-2x fa-credit-card addIcon" id="addIcon"></i></a></div>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="fprom-group"><?php echo form_submit('add_sale', $this->lang->line("submit"), 'id="add_sale" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?><button type="button" class="btn btn-danger" id="reset"><?= lang('reset') ?></div></div>            
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="pr_popover_content">
                <form class="form-horizontal" role="form">
                    ...
                    <?php } ?>
                    <div class="form-group">
                        <label for="pprice" class="col-sm-4 control-label"><?= lang('price') ?></label>
                        <div class="col-sm-8">
