...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form'); echo form_open("sales/add_gift_card", $attrib); ?>  
        <div class="modal-body">
            ...
            <div class="form-group">
                <input type="checkbox" class="checkbox" name="staff_points" id="staff_points"><label for="staff_points" class="padding05"><?= lang('use_staff_award_points'); ?></label>
            </div>
            ...
            <div id="customer-con">
                ...
                <div class="well well-sm" id="award-points-con" style="display:none;">
                    <div class="form-group">
                        ...
                        <input type="checkbox" class="checkbox" name="use_points" id="use_points"><label for="use_points" class="padding05"><?= lang('use_award_points'); ?></label>
                    </div>
