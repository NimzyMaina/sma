...
<script>
    $(document).ready(function() {
        var oTable = $('#RESLData').dataTable({
            ...
            "aoColumns": [{"mRender": fld}, null, null, null, null, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"bSortable": false, "bVisible": false, "mRender": checkbox}, {"bSortable": false, "bVisible": false}],
         ...
         {column_number : 5, filter_default_label: "[<?=lang('payment_status');?>]", filter_type: "text" },
         ], "footer");
...
<?php if ($Owner) { echo form_open('sales/return_actions', 'id="action-form"'); } ?>
<div class="box">
