        ...
        <?php if ($inv) { ?>
            ...
            <?php if ($Owner || $Admin) { ?>
                if (!localStorage.getItem('redate')) {
                    $( "#redate" ).datetimepicker({format: site.dateFormats.js_ldate, fontAwesome: true, language: 'sma', weekStart: 1, todayBtn: 1, autoclose: 1, todayHighlight: 1, startView: 2, forceParse: 0}).datetimepicker('update', new Date());
                }
...
$(document).on("focus", '.rquantity', function () {
    ...
    if (!is_numeric(new_qty) || (new_qty > reitems[item_id].row.quantity)) {
...
$(document).on('click', '.redel', function () {
    ...
    if (site.settings.product_discount == 1) {
        idiscount = formatMoney($.trim(row.children().children('.sdiscount').text()));
    ...
    count -= iqty;
        ...
        var gtotal = ((total + product_tax + invoice_tax) - total_discount);
        if (return_surcharge = localStorage.getItem('return_surcharge')) {
        ...
        //console.log(slitems[item_id].row.name + ' is being removed.');
    ...
    function loadItems() {
        ...
        if (localStorage.getItem('reitems')) {
            ...
            tr_html = '<td><input name="sale_item_id[]" type="hidden" class="rsiid" value="' + sale_item_id + '"><input name="product_id[]" type="hidden" class="rid" value="' + product_id + '"><input name="product_type[]" type="hidden" class="rtype" value="' + item_type + '"><input name="product_code[]" type="hidden" class="rcode" value="' + item_code + '"><input name="option_id[]" type="hidden" class="roption" value="' + item_option + '"><input name="product_name[]" type="hidden" class="rname" value="' + item_name + '"><span class="sname" id="name_' + row_no + '">' + item_name + ' (' + item_code + ')</span></td>';
            tr_html += '<td class="text-right"><input class="form-control input-sm text-right rprice" name="net_price[]" type="hidden" id="price_' + row_no + '" value="' + item_price + '"><span class="text-right sprice" id="sprice_' + row_no + '">' + formatMoney(item_price) + '</span></td>';
        ...
        var gtotal = parseFloat(((total + product_tax + invoice_tax) - total_discount));
        ...
        $('#gtotal').text(formatMoney(gtotal));
        <?php if($inv->payment_status == 'paid') { echo "$('#amount_1').val(formatMoney(gtotal));"; } ?>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : ''), 'class="form-control input-tip" id="reref" required="required"'); ?> 
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                        ...
                                        <div class="gc" style="display: none;">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-addon" style="padding-left: 10px; padding-right: 10px; height:25px;"><a href="#" id="sellGiftCard" class="tip" title="<?=lang('sell_gift_card')?>"><i class="fa fa-credit-card"></i></a></div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="fprom-group"><?php echo form_submit('add_return', $this->lang->line("submit"), 'id="add_return" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?></div></div>            
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-addon" style="padding-left: 10px; padding-right: 10px;"><a href="#" id="noCus" class="tip" title="<?=lang('unselect_customer')?>"><i class="fa fa-times"></i></a></div>
                        </div>
                    </div>
                    <div class="form-group">
