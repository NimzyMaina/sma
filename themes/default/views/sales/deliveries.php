<script>
    $(document).ready(function () {
        ...
        {column_number : 2, filter_default_label: "[<?=lang('do_reference_no');?>]", filter_type: "text" },
        {column_number : 3, filter_default_label: "[<?=lang('sale_reference_no');?>]", filter_type: "text" },
        {column_number : 4, filter_default_label: "[<?=lang('customer');?>]", filter_type: "text"},
        {column_number : 5, filter_default_label: "[<?=lang('address');?>]", filter_type: "text" },
        ], "footer");
    });
</script>
