...
<div class="box sales-table">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-heart"></i><?= lang('customer_sales_report'); ?> <?php
if ($this->input->post('start_date')) {
    ...
    $(document).ready(function () {
        ...
        var oTable = $('#PayRData').dataTable({
            ...
            'fnRowCallback': function(nRow, aData, iDisplayIndex) {
                ...
                if(aData[6] == 'returned') { nRow.className = "danger"; }
                return nRow;
            },
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                var total = 0;
        ...
        {column_number : 2, filter_default_label: "[<?=lang('sale_ref');?>]", filter_type: "text" },
...
<div class="box payments-table">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-money"></i><?= lang('customer_payments_report'); ?> <?php
            if ($this->input->post('start_date')) {
                echo "From " . $this->input->post('start_date') . " to " . $this->input->post('end_date');
            }
            ?></h2>
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                ...
                <li class="dropdown"><a href="#" id="image1" class="tip" title="<?=lang('save_image')?>"><i class="icon fa fa-file-picture-o"></i></a></li>
            </ul>
        </div>
    </div>
    <div class="box-content">  
...
<?php echo form_close(); ?>
                ...
                <div class="clearfix"></div>
                    ...
                    <div class="table-responsive">
                        <table id="PayRData" class="table table-bordered table-hover table-striped table-condensed reports-table reports-table">
