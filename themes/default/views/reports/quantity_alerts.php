<script>
    $(document).ready(function () {
        var oTable = $('#PQData').dataTable({
            ...
            "aoColumns": [{"bSortable": false, "mRender": img_hl}, null, null, {"mRender": formatQuantity}, {"mRender": formatQuantity}],
        ...
        {column_number : 3, filter_default_label: "[<?=lang('quantity');?>]", filter_type: "text" },
        {column_number : 4, filter_default_label: "[<?=lang('alert_quantity');?>]", filter_type: "text"},
        ], "footer");
    });
</script>
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-calendar-o"></i><?= lang('product_quantity_alerts').' ('.($warehouse_id ? $warehouse->name : lang('all_warehouses')).')'; ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= site_url('reports/quantity_alerts') ?>"><i class="fa fa-building-o"></i> <?= lang('all_warehouses') ?></a></li>
                        <li class="divider"></li>
                        <?php
