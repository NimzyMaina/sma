...
<script>
    $(document).ready(function() {
        var oTable = $('#registerTable').dataTable({
            ...
            "aoColumns": [ {"mRender": fld}, {"mRender": fld}, null, {"mRender": currencyFormat}, null, null, {"mRender": currencyFormat}, {"bSortable": false} ]
        }).fnSetFilteringDelay().dtFilter([
        {column_number : 0, filter_default_label: "[ yyyy-mm-dd HH:mm:ss ]", filter_type: "text" },
        {column_number : 1, filter_default_label: "[ yyyy-mm-dd HH:mm:ss ]", filter_type: "text", data: [] },
        {column_number : 2, filter_default_label: "[<?=lang('user');?>]", filter_type: "text" },
        {column_number : 3, filter_default_label: "[<?=lang('cash_in_hand');?>]", filter_type: "text"},
