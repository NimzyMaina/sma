...
<ul id="myTab" class="nav nav-tabs">
    ...
    <li class=""><a href="#targets-con" class="tab-grey"><?=lang('sales_target')?></a></li>
...
<div class="tab-content">
    ...
    <div id="monthly-con" class="tab-pane fade in">
        ...
        <div id="targets-con" class="tab-pane fade in">
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><i class="fa-fw fa fa-calendar nb"></i> <?= lang('target_sales'); ?></h2>
                <div class="box-icon">
                    <ul class="btn-tasks">
                        <li class="dropdown"><a href="#" id="pdf1" class="tip" title="<?=lang('download_pdf')?>"><i class="icon fa fa-file-pdf-o"></i></a></li>
                        <li class="dropdown"><a href="#" id="image1" class="tip image" title="<?=lang('save_image')?>"><i class="icon fa fa-file-picture-o"></i></a></li>
            ...
            <div class="box-content">
                <div class="row">
                    <div class="col-lg-12">
                        <p class="introtext"><?= lang("reports_calendar_text") ?></p>
                        <?php
                        echo $this->session->set_userdata(array('temp' => $this->uri->segment(3)));
                        ?>
                        <div class="table-responsive">
                            <table class="table table-bordered dfTable reports-table">
                                <tr class="year_roller">
                                    <th><div class="text-center"> <a href="reports/target_sales/<?= $year - 1 ?>">&lt;&lt;</a> </div></th>
                                    <th colspan="10"><div class="text-center"> <?= $year; ?> </div></td>
                                        <th><div class="text-center"> <a href="reports/target_sales/<?= $year + 1 ?>">&gt;&gt;</a> </div></th>
                                    </th>
                                </tr> 
        ...
        $(document).ready(function () {
            ...
            var oTable = $('#PayRData').dataTable({
                ...
                'fnRowCallback': function(nRow, aData, iDisplayIndex) {
                    ...
                    if(aData[6] == 'sent'){ nRow.className = "warning"; } else if(aData[6] == 'returned') { nRow.className = "danger"; }
                    return nRow;
                },
                "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                    var total = 0;
            ...
            {column_number : 0, filter_default_label: "[<?=lang('date');?> (yyyy-mm-dd)]", filter_type: "text" },
            {column_number : 1, filter_default_label: "[<?=lang('payment_ref');?>]", filter_type: "text" },
            ...
            {column_number : 4, filter_default_label: "[<?=lang('paid_by');?>]", filter_type: "text" },
            {column_number : 6, filter_default_label: "[<?=lang('type');?>]", filter_type: "text" },
            ], "footer");
});
</script>
        ...
        <div class="box-content">  
            <div class="row">            
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <div class="controls"> <?= form_submit('submit_report', lang("submit"), 'class="btn btn-primary"'); ?> </div>
                    </div>
                    <?= form_close(); ?>
                    ...
                    ?>
                        <script>
                            $(document).ready(function() {
                                ...
                                {column_number : 0, filter_default_label: "[<?=lang('email');?>]", filter_type: "text" },
                                {column_number : 1, filter_default_label: "[<?=lang('ip_address');?>]", filter_type: "text" },
                                {column_number : 2, filter_default_label: "[<?=lang('time');?> (yyyy-mm-dd HH:mm)]", filter_type: "text" },
                                ], "footer");
                            });
