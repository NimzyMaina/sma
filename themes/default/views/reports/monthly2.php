...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-calendar"></i><?= lang('target_sales'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                ...
                <div class="table-responsive">
                    ...
                    <thead>
                        <tr class="year_roller">
                            <th><a class="white" href="reports/target_sales/<?php echo $year - 1; ?>">&lt;&lt;</a></th>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#pdf').click(function(event) {
            ...
            window.location.href = "<?=site_url('reports/rarget_sales/'.$year.'/pdf')?>";
            return false;
        });
