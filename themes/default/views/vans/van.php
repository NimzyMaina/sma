<script>
    $(document).ready(function() {
        ...
        $('#CURData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('van/getVans') ?>',
...
<?= form_open('van/van_actions', 'id="action-form"') ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?php echo site_url('van/add_van'); ?>" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> <?= lang('add_van') ?></a></li>
