<script>
    $(document).ready(function() {
        var oTable = $('#SupData').dataTable({
         ...
         {column_number : 3, filter_default_label: "[<?=lang('vat_no');?>]", filter_type: "text"},
         {column_number : 4, filter_default_label: "[<?=lang('phone');?>]", filter_type: "text" },
         {column_number : 5, filter_default_label: "[<?=lang('email_address');?>]", filter_type: "text" },
         {column_number : 6, filter_default_label: "[<?=lang('city');?>]", filter_type: "text" },
         {column_number : 7, filter_default_label: "[<?=lang('country');?>]", filter_type: "text" },
         ], "footer");
    });
</script>
<?php if ($Owner) { echo form_open('billers/biller_actions', 'id="action-form"'); } ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= site_url('billers/add'); ?>" data-toggle="modal" data-target="#myModal" id="add"><i class="fa fa-plus-circle"></i> <?= lang("add_biller"); ?></a></li>
