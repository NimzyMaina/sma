...
$('#from_warehouse').on("select2-focus", function (e) {
    ...
    if ($(this).val() == $('#to_warehouse').val()) {
        ...
        $('#tostatus').change(function(){
            if(status == 'completed') {
                bootbox.alert('<?=lang('can_not_change_status_of_completed_transfer')?>');
                ...
                <div class="row">            
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="from-group"><?php echo form_submit('edit_transfer', $this->lang->line("submit"), 'id="edit_transfer" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?><button type="button" class="btn btn-danger" id="reset"><?= lang('reset') ?></button></div>
                        </div>  
