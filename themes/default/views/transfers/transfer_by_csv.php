                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : $rnumber), 'class="form-control input-tip" id="toref" required="required"'); ?> 
                            </div>
                        </div>
                        ...
                        <div class="col-md-12" id="sticker">
                            <div class="well well-sm">
                                ...
                                <span class="text-warning"><?=lang("csv1");?></span><br /><?= lang("csv2"); ?> <span class="text-info">(<?= lang("product_code"); ?>, <?= lang("quantity"); ?>, <?= lang("product_variant");?>, <?= lang("expiry");?>)</span> <?= lang("csv3"); ?><br>
