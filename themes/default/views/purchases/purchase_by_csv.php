...
<div class="box">
    ...
    <span class="text-warning"><?php echo $this->lang->line("csv1"); ?></span><br>
        <?php echo $this->lang->line("csv2"); ?> <span class="text-info">(<?= lang("product_code").', '.lang("net_unit_cost").', '.lang("quantity").', '.lang("product_variant").', '.lang("tax_rate_name").', '.lang("discount").', '.lang("expiry"); ?>)</span> <?php echo $this->lang->line("csv3"); ?><br>
...
<?= lang("csv_file", "csv_file") ?>
                        <input id="csv_file" type="file" name="userfile" required="required" data-show-upload="false" data-show-preview="false" class="form-control file">
                    </div>
                    </div>
                <div class="clearfix"></div>
                <div class="col-md-6">
