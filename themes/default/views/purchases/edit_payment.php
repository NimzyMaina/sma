                                    ...
                                    <div class="well well-sm well_1">
                                        ...
                                        <div class="payment">
                                            <div class="form-group">
                                                ...
                                                <input name="amount-paid" value="<?=$this->sma->formatDecimal($payment->amount);?>" type="text" id="amount_1" class="pa form-control kb-pad amount" required="required"/>
                                            </div> 
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="paid_by" id="paid_by_1" class="form-control paid_by" required="required">
                                                    ...
                                                    <option value="CC"<?=$payment->paid_by == 'CC' ? ' checked="checcked"' : ''?>><?= lang("cc"); ?></option>
                                                    <option value="Cheque"<?=$payment->paid_by == 'Cheque' ? ' checked="checcked"' : ''?>><?= lang("cheque"); ?></option>
                                                    <option value="other"<?=$payment->paid_by == 'other' ? ' checked="checcked"' : ''?>><?= lang("other"); ?></option>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="pcc_1" style="display:none;">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <select name="pcc_type" id="pcc_type_1" class="form-control pcc_type" placeholder="<?= lang('card_type') ?>">
                                                                <option value="Visa"<?=$payment->cc_type == 'Visa' ? ' checked="checcked"' : ''?>><?= lang("Visa"); ?></option>
                                                                <option value="MasterCard"<?=$payment->cc_type == 'MasterCard' ? ' checked="checcked"' : ''?>><?= lang("MasterCard"); ?></option>
                                                                <option value="Amex"<?=$payment->cc_type == 'Amex' ? ' checked="checcked"' : ''?>><?= lang("Amex"); ?></option>
                                                                <option value="Discover"<?=$payment->cc_type == 'Discover' ? ' checked="checcked"' : ''?>><?= lang("Discover"); ?></option>
                                                            </select>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <input name="pcc_month" value="<?=$payment->cc_month;?>" type="text" id="pcc_month_1" class="form-control" placeholder="<?= lang('month') ?>" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">

                                                            <input name="pcc_year" value="<?=$payment->cc_year;?>" type="text" id="pcc_year_1" class="form-control" placeholder="<?= lang('year') ?>" />
                                                        </div>
                                                    </div>
                                                    <!--<div class="col-md-3">
                                                        <div class="form-group">
