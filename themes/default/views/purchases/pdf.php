                        ...
                        <table class="table table-bordered table-hover table-striped">
                            ...
                            <tbody> 
                                ...
                                <tr>
                                    ...
                                    <?php
                                    if ($Settings->tax1) {
                                        echo '<td style="width: 100px; text-align:right; vertical-align:middle;">'.($row->item_tax != 0 ? '<small>(' . $row->tax . ')</small> ' : '') . $this->sma->formatMoney($row->item_tax).'</td>';
                                    }
                                    ?>
                                    <?php 
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                        <td style="text-align:right;"><?= $this->sma->formatMoney($inv->total+$inv->product_tax-$inv->product_discount); ?></td>
                                    </tr>
                                    <?php 
                                    if($inv->order_discount != 0) { echo  '<tr><td colspan="' . $col . '" style="text-align:right;">' . lang("order_discount") . ' (' . $default_currency->code . ')</td><td style="text-align:right;">' . $this->sma->formatMoney($inv->order_discount) . '</td></tr>'; 
                                } 
