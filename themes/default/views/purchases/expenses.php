<script>
    $(document).ready(function () {
        ...
        var oTable = $('#EXPData').dataTable({
            ...
            "aoColumns": [{"bSortable": false, "mRender": checkbox}, {"mRender": fld}, null, {"mRender": currencyFormat}, null, null, {"bSortable": false, "mRender": attachment}, {"bSortable": false}],
        ...
        {column_number : 2, filter_default_label: "[<?=lang('reference');?>]", filter_type: "text" },
        {column_number : 4, filter_default_label: "[<?=lang('note');?>]", filter_type: "text" },
        {column_number : 5, filter_default_label: "[<?=lang('created_by');?>]", filter_type: "text"},
        ], "footer");
...
<?php if ($Owner) { echo form_open('purchases/expense_actions', 'id="action-form"'); } ?>
<div class="box">
